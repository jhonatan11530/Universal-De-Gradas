        ...
        <div class="section">
                ...
                <div class="col s12 m4">
                    <div class="card">
                        <div class="card-image">
                            <img id="card" class="materialboxed" src="{{ asset('img/Grada_metalica/1.jpg') }}">
                        </div>
                    </div>
                </div>
                <div class="col s12 m4">
                    <div class="card">
                        <div class="card-image">
                            <img id="card" class="materialboxed" src="{{ asset('img/Grada_metalica/2.jpg') }}">
                        </div>
                    </div>
                </div>
                <div class="col s12 m4">
                    <div class="card">
                        <div class="card-image">
                            <img id="card" class="materialboxed" src="{{ asset('img/Grada_metalica/3.jpg') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row ">
                <div class="col s12 m4">
                    <div class="card">
                        <div class="card-image">
                            <img id="card" class="materialboxed" src="{{ asset('img/Grada_metalica/4.jpg') }}">
                        </div>
                    </div>
                </div>
            </div>
